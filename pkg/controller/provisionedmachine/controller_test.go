...
import (
	...
	. "github.com/platform9/ssh-provider/pkg/client/clientset_generated/clientset/typed/sshprovider/v1alpha1"
...
var _ = Describe("ProvisionedMachine controller", func() {
	var instance ProvisionedMachine
	var expectedKey string
	var client ProvisionedMachineInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = ProvisionedMachine{}
		instance.Name = "instance-1"
		expectedKey = "provisionedmachine-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.SshproviderV1alpha1().ProvisionedMachines("provisionedmachine-controller-test-handler")
