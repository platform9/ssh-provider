			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"etcdCASecret": {
							SchemaProps: spec.SchemaProps{
								Description: "EtcdCASecret is the name of the Secret with the etcd CA certificate and private key. If it is not specified, the default name is derived from the cluster name. If the Secret is not present, the provider generates a self-signed one and creates the Secret.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
						"apiServerCASecret": {
							SchemaProps: spec.SchemaProps{
								Description: "APIServerCASecret is the name of the Secret with the kube-apiserver CA certificate and private key. If it is not specified, the default name is derived from the cluster name. If the Secret is not present, the provider generates a self-signed one and creates the Secret.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
						"frontProxyCASecret": {
							SchemaProps: spec.SchemaProps{
								Description: "FrontProxyCASecret is the name of the Secret with the front-proxy CA certificate and private key. If it is not specified, the default name is derived from the cluster name. If the Secret is not present, the provider generates a self-signed one and creates the Secret.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
						"serviceAccountKeySecret": {
							SchemaProps: spec.SchemaProps{
								Description: "ServiceAccountKeySecret is the name of the Secret with the private and public keys used to generate Service Account tokens. If it is not specified, the default name is derived from the cluster name. If the Secret is not present, the provider generates a self-signed one and creates the Secret.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
						"bootstrapTokenSecret": {
							SchemaProps: spec.SchemaProps{
								Description: "BootstrapTokenSecret is the name of the Secret with the bootstrap token used by kubeadm join. If it is not specified, the default name is derived from the cluster name. The provider periodically ensures the Secret contains a valid bootstrap token.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
						"vipConfiguration": {
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"etcdMembers": {
							SchemaProps: spec.SchemaProps{
								Description: "EtcdMembers defines the observed etcd configuration of the cluster.",
								Type:        []string{"array"},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"name": {
							SchemaProps: spec.SchemaProps{
								Description: "Name is the human-readable name of the member.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"clientURLs": {
							SchemaProps: spec.SchemaProps{
								Description: "ClientURLs is the list of URLs the member exposes to clients for communication.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"provisionedMachineName": {
							SchemaProps: spec.SchemaProps{
								Description: "ProvisionedMachineName is the binding reference to the Provisioned Machine backing this Machine.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"vipNetworkInterface": {
							SchemaProps: spec.SchemaProps{
								Description: "Network interface used to create the virtual IP. This field is populated for masters only.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"vipNetworkInterface": {
							SchemaProps: spec.SchemaProps{
								Description: "Network interface chosen to create the virtual IP. If it is not specified, the interface of the default gateway is chosen.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
					},
					Required: []string{"sshConfig"},
				},
			},
			Dependencies: []string{
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						"machineRef": {
							SchemaProps: spec.SchemaProps{
								Description: "MachineRef is part of a bi-directional binding between ProvisionedMachine and Machine. MachineRef is expected to be non-nil when bound. provisionedmachine.MachineRef is the authoritative bind between ProvisionedMachine and Machine. When set to non-nil value, Machine.Spec.Selector of the referenced Machine is ignored, i.e. labels of this ProvisionedMachine do not need to match Machine selector.",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
					},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						"host": {
							SchemaProps: spec.SchemaProps{
								Description: "The IP or hostname used to SSH to the machine",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"port": {
							SchemaProps: spec.SchemaProps{
								Description: "The used to SSH to the machine",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
						"publicKeys": {
							SchemaProps: spec.SchemaProps{
								Description: "The SSH public keys of the machine",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"CredentialSecret": {
							SchemaProps: spec.SchemaProps{
								Description: "The Secret with the username and private key used to SSH to the machine",
								Ref:         ref("k8s.io/api/core/v1.LocalObjectReference"),
							},
						},
					},
					Required: []string{"host", "port", "publicKeys", "CredentialSecret"},
				},
			},
			Dependencies: []string{
				"k8s.io/api/core/v1.LocalObjectReference"},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"routerID": {
							SchemaProps: spec.SchemaProps{
								Description: "The virtual router ID. Must be in the range [0, 254]. Must be unique within a single L2 network domain.",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
