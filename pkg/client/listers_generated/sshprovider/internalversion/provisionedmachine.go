...
type ProvisionedMachineLister interface {
	...
	List(selector labels.Selector) (ret []*sshprovider.ProvisionedMachine, err error)
...
// List lists all ProvisionedMachines in the indexer.
func (s *provisionedMachineLister) List(selector labels.Selector) (ret []*sshprovider.ProvisionedMachine, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*sshprovider.ProvisionedMachine))
	})
	return ret, err
}
...
type ProvisionedMachineNamespaceLister interface {
	...
	Get(name string) (*sshprovider.ProvisionedMachine, error)
...
// List lists all ProvisionedMachines in the indexer for a given namespace.
func (s provisionedMachineNamespaceLister) List(selector labels.Selector) (ret []*sshprovider.ProvisionedMachine, err error) {
...
// Get retrieves the ProvisionedMachine from the indexer for a given namespace and name.
func (s provisionedMachineNamespaceLister) Get(name string) (*sshprovider.ProvisionedMachine, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(sshprovider.Resource("provisionedmachine"), name)
	}
	return obj.(*sshprovider.ProvisionedMachine), nil
}
